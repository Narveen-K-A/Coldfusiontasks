        ...
        <cflock SCOPE="Session" TYPE="Exclusive" TIMEOUT="120">
            <cfif structKeyExists(form, 'submit')>
                ...
                <cfif len(trim(form.file))>
                    <cffile action="upload" fileField="file" nameConflict="overwrite" accept="image/jpg,image/jpeg,image/gif,image/png" result="thisResult" destination="C:\ColdFusion2018\cfusion\wwwroot\Coldfusiontask\Cftask14\assets\">
                    ...
                    <cfelse>
                            ...
                            <cfimage action="resize" source="C:\ColdFusion2018\cfusion\wwwroot\Coldfusiontask\Cftask14\assets\#session.location#" width="20" height="20" destination="C:\ColdFusion2018\cfusion\wwwroot\Coldfusiontask\Cftask14\assets\duplicate\#session.location#" overwrite="true">
                    </cfif>    
                </cfif>    
            </cfif>
